...
const fixedCalcultions = (country_region, motorPower) => {
  ...
  const isPeru =
    country_region && country_region.country === countries_region[PERU].country
  const isEquador =
    country_region &&
    country_region.country === countries_region[EQUADOR].country
  const isColombia =
    country_region &&
    country_region.country === countries_region[COLOMBIA].country
