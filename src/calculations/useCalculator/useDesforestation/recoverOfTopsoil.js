...
const recoveryOfTopsoil = () => {
  ...
  const precoRecSuperficialHa = CONSERVATIVE === 1 ? precoRecupSuperficialSoloporHa_conservative : precoRecupSuperficialSoloporHa;
  ...
  const custoTransporteMudaporKmBRL = 1.60;
