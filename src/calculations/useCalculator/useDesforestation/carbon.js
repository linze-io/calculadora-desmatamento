...
const carbon = () => {
    ...
    */
    ...
    const multi_TxCambio_custoCarbono_saldoCarbonoPorHa = txCambio * custoCarbonoPorHaUSD * saldoCarbonoPorHa


    //Função PGTO
    const carbonoPGTOReais = pgto(multi_TxCambio_custoCarbono_saldoCarbonoPorHa, txDisconto, qtdAnos)
